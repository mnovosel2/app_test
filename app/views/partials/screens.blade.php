            <section id="screens">
                <div class="container">
                    ...
                    <div class="slider filtering scrollpoint sp-effect5" >
                        <div class="one">
                            <img src="/assets/img/eco/screens/profile.jpg" alt="">
                            <h4>Profile Page</h4>
                        </div>
                        <div class="two">
                            <img src="/assets/img/eco/screens/menu.jpg" alt="">
                            <h4>Toggel Menu</h4>
                        </div>
                        <div class="three">
                            <img src="/assets/img/eco/screens/weather.jpg" alt="">
                            <h4>Weather Forcast</h4>
                        </div>
                        <div class="one">
                            <img src="/assets/img/eco/screens/signup.jpg" alt="">
                            <h4>Sales Analysis</h4>
                        </div>
                        <div class="one">
                            <img src="/assets/img/eco/screens/calendar.jpg" alt="">
                            <h4>Event Calendar</h4>
                        </div>
                        <div class="two">
                            <img src="/assets/img/eco/screens/options.jpg" alt="">
                            <h4>Some Options</h4>
                        </div>
                        <div class="three">
                            <img src="/assets/img/eco/screens/sales.jpg" alt="">
